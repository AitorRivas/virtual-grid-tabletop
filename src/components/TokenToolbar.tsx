  ...
  return (
    <div className="bg-card/95 backdrop-blur-sm border-r border-border/50 flex flex-col h-full">
      <Tabs defaultValue="tokens" className="flex-1 flex flex-col min-h-0 overflow-hidden">
                          ...
                          <div className="px-2.5 pb-2.5 pt-0 space-y-3 border-t border-border/30">
                            ...
                            <div className="space-y-2">
                              <div className="flex items-center justify-between">
                                ...
                                >
                                  {token.lightEnabled ? 'Activo' : 'Inactivo'}
                                </Button>
                              </div>
                              {token.lightEnabled && (
                                <div className="pl-1">
                                  <div className="flex justify-between text-[10px] mb-0.5">
                                    <span className="text-muted-foreground">Radio de exploración</span>
                                    <span>{token.lightRadius ?? 120}px</span>
                                  </div>
                                  <Slider
                                    value={[token.lightRadius ?? 120]}
        ...
        <TabsContent forceMount value="library" className="m-0 min-h-0 overflow-hidden data-[state=inactive]:hidden data-[state=active]:flex data-[state=active]:flex-col data-[state=active]:flex-1">
          {user ? (
            <CharacterManager
