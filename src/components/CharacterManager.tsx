...
export const CharacterManager = ({ onAddCharacterToMap, onAddMonsterToMap }: CharacterManagerProps) => {
  ...
  // Sheets opened via the global `vtt:open-*-sheet` CustomEvents are handled
  // exclusively by <GlobalSheetOpener />. Listening here too caused duplicate
  // dialogs when the Biblioteca tab was active.
